      ...
      <div style={{ width: '100%', float: 'left' }}>
        ...
        {price > 0 && (
          <div className="Desktop-price-section">
            ...
            {discount > 0 && (
              <>
                <span className="Desktop-original-price">${price.toFixed(2)}</span>
        ...
        <div className={`Desktop-quantity ${language === 'ar' ? 'rtl' : 'ltr'}`}>
          ...
          <>
            ...
            <div className={`Desktop-quantity-selector ${language === 'ar' ? 'rtl' : 'ltr'}`}>
              <h3 className="Mobile-quantity-title">  {language === "ar" ? "الكمية" : "Quantity"}
              </h3></div>
            <div className="Mobile-quantity-selector">

              <div className="Mobile-quantity-but">
                <button className="Mobile-quantity-button" onClick={decreaseQuantity}>
                  -
                </button>
                <span className="Mobile-quantity-value">{quantity}</span>
                <button className="Mobile-quantity-button" onClick={increaseQuantity}>
                  +
                </button>
              </div>
            </div>
