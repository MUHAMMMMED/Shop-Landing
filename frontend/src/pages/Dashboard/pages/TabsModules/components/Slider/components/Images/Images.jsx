...
export default function Images({ images = [], Id, language }) {
    ...
    const URL = `${Config.baseURL}/api/content/image_slider/`;
    ...
    const handleFileUpload = async (event) => {
        ...
        if (file) {
            ...
            formData.append('slider_id', Id); // Append the product ID to associate with the image
                ...
                <div className="upload-box">
                    ...
                    <label htmlFor="file-upload">
                        ...
                        <input
                            id="file-upload"
                            type="file"
                            accept=".png, .jpg, .jpeg, .gif, .webp" // Supported file types
