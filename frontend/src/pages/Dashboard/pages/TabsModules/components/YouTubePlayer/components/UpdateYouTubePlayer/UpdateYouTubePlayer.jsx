...
const UpdateYouTubePlayer = () => {
    const { youtubeId, page_id, section_id } = useParams();
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await AxiosInstance.get(`${Config.baseURL}/api/content/youtube/${youtubeId}`);
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            await AxiosInstance.put(`${Config.baseURL}/api/content/youtube/${youtubeId}/`, formData);
            setError('');

            navigate(`/modules/${page_id}/${section_id}/`);
        } catch (err) {
            console.error(err);
            setError('Failed to update youtube player');
        }
    };
                            ...
                            <div className="Product-section Product-section-one">
                                <div className='Product-section-row'>
                                    ...
                                    <input
                                        ...
                                        placeholder="Enter the video_id"
                                    />
                                </div>
...
export default UpdateYouTubePlayer;